//W5CLCM@# JOB (SYS),'Mandelbrot color',CLASS=B,MSGCLASS=A              00010000
...
C
      ...
      COMPLEX*16 Z
      CZERO = .TRUE.
      IF (CDABS(Z) .GT. 0) THEN DO
        CZERO = .FALSE.
      END IF
      RETURN
      END
      FUNCTION MAND (ZIN, ITER, MAXITR)
      IMPLICIT REAL*8 (A-H, O-Z)
      COMPLEX*16 MAND
      COMPLEX*16 ZIN
      COMPLEX*16 Z, C
