//VOLS$    JOB (SYS),'INSTALL VOLS',CLASS=S,MSGCLASS=A                  00010000
//*                                                                     00020000
//* ***************************************************************** * 00030000
//* INSTALL VOLS COMMAND IN SYS2.CMDLIB (HELP IN SYS2.HELP)           * 00040000
//* ***************************************************************** * 00050000
//*                                                                     00060000
//VOLS    EXEC ASMFCL,PARM.ASM='LIST,NODECK,LOAD,RENT',                 00070000
//             MAC1='SYS1.AMODGEN',PARM.LKED='LIST,MAP,NOCAL,RENT'      00080000
...
*                                                                     * 03920000
* DOUG WEGSCHEID 04/28/20 6C. FIX T(3340)                             * 03921000
*                                                                     * 03922000
*---------------------------------------------------------------------* 03930000
         SPACE 2                                                        03940000
...
T3340    EQU   *                                                    #6B 06710000
         ...
         TM    SELDEVT,DEVT3340    CHECK FOR 3340 SELECTION         #6C 06740000
...
END1     DC    C'**PROCESSING COMPLETED**  ---  VOLS REL.01 MOD.6C' #6C 07620000
